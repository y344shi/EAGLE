...
void sink_reason(hls::stream<tmac::hls::vec_t<tmac::hls::VEC_W>>& reasoning_stream,
...
#pragma HLS STREAM variable=logits_out depth=64
    e4_t1_l0(hidden_in_stream, embed_in_stream, reasoning_out, logits_out,
    ...
    sink_reason(reasoning_out, reasoning_state_out);
...
#pragma HLS ARRAY_PARTITION variable=low_rank cyclic factor=16 dim=2
    ...
    collect_logits(logits_out, logits_hidden);
