...
"${CXX}" "${CXXFLAGS[@]}" "${HOST_LINK_INCLUDES[@]}" cost_draft_tree_fused_wiring_tb.cpp -o /tmp/cdt_fused_wiring_tb_check
"${CXX}" "${CXXFLAGS[@]}" "${HOST_LINK_INCLUDES[@]}" cost_draft_tree_multilayer_orchestrator_tb.cpp -o /tmp/cdt_multilayer_orch_tb_check
