#ifndef TMAC_SYSTOLIC_ATTENTION_FUSED_HPP
#define TMAC_SYSTOLIC_ATTENTION_FUSED_HPP
...
void systolic_attention_fused(hls_stream<vec_t<VEC_W>>& q_stream,
...
#endif // TMAC_SYSTOLIC_ATTENTION_FUSED_HPP
